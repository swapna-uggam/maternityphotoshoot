      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="w-full h-full flex flex-col">
            <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-xl border border-gray-100 flex-grow flex flex-col relative overflow-hidden">
              <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4">Contact Information</h3>

              {/* Enhanced Floating camera animation */}
              <motion.div 
              ...
              <address className="text-gray-600 not-italic space-y-4 text-sm sm:text-base flex-grow flex flex-col justify-center mt-16 z-10">
                {[
                  {
              ...
              {[...Array(8)].map((_, i) => (
                <motion.div
                  ...
                  animate={{
                    opacity: [0, 0.8, 0],  // Increased peak opacity
                    y: [-20, -80],
                  }}
                  transition={{
